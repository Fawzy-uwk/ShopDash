  ...
  return (
    <div className="mt-24">
      <div className="flex flex-wrap justify-center items-center w-full h-full">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg lg:h-48 h-full rounded-xl w-full lg:w-[80%] p-6 pt-10 m-3 bg-no-repeat bg-hero-pattern bg-conver bg-center">
